...
def mav_cmd_do_orbit(radius, velocity, yaw_behavior, orbits, latitude_x, longitude_y, altitude_z):
...
def mav_cmd_nav_vtol_land(land_options, approach_altitude, yaw, latitude, longitude, ground_altitude):
...
def mav_cmd_preflight_set_sensor_offsets(sensor_type, x_offset, y_offset, z_offset, 4th_dimension, 5th_dimension, 6th_dimension):
